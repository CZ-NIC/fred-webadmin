...
class Initializer(object):
    ...
    def init_itertable(self, pagetable_mock, columnDesc=None, start=0, 
                       pageSize=1, numPages=1, numPageRows=10):
        ...
        self.mock__update(pagetable_mock, start, pageSize, numPages, 
                          numPageRows)
       
    def mock__update(self, pagetable_mock, start=1, pageSize=1, numPages=1, 
                     numPageRows=10):
        """ Utility method to prevent boilerplate code.
            Simulates IterTable._update method. """
        pagetable_mock._get_page().InAnyOrder("update pt").AndReturn(1)
        ...
        pagetable_mock._get_numRows().InAnyOrder("update pt").AndReturn(10)
        pagetable_mock.numRowsOverLimit().InAnyOrder("update pt").AndReturn(50)
...
class TestGetRowDict(Initializer):
    ...
    def test_get_rows_dict_multiple_rows(self):
        ...
        self.mock__update(self.pagetable_mock)
        for i in range(5, 15):
